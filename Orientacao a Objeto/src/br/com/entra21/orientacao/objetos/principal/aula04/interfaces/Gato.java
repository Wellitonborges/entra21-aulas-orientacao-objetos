...
public class Gato implements Individuo {
	...
	public void alimentar(String alimento) {
		System.out.println(this.nome + "iau.. posso não gostar disso, mas meu dono  " + this.dono.getNome()+" So me da " + alimento);
	...
	System.out.println(this.nome+" miau miau miau .... Traduzinfo  "+conteudo);
